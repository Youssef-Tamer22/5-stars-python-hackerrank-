...
Python 3 solutions to 23 challenges from HackerRank's **Python** domain (Introduction, Basic Data Types, Strings, Sets, and Collections), packaged as a single Jupyter notebook.
...
- Each solution was actually executed locally against a real HackerRank sample input, and the **real output is attached to each cell** — open the notebook and you'll see exactly what each script produces, no need to run it yourself.
