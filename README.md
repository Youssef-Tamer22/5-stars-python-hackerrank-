...
Python 3 solutions to 23 challenges from HackerRank's Python domain (Introduction, Basic Data Types, Strings, Sets, and Collections), collected in hackerrank-python-solutions.md.
